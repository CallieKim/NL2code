# coding=utf-8
# referenced from https://github.com/pcyin/tranX/blob/master/datasets/conala/util.py
...
#check if t is appropriate as an identifier name
def isIdentifier(t):
    if t in keyword.kwlist:
        return False
    return re.match(r'^[a-z_][a-z0-9_]*$', t, re.I) is not None
